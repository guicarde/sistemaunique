     ...
     <?php require 'Cabecera.php' ?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Subir Consolidado de Requerimientos
            <small>Ingrese Adjunto en excel</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="index.php"><i class="fa fa-user"></i> REQUERIMIENTOS</a></li>
            <li><a href="index.php">Requerimientos</a></li>
            <li class="active">Subir Requerimientos</li>
          </ol>
        </section>
           ...
           <div class="col-md-12">
              ...
              <div class="box box-info">
                ...
                <form class="form-horizontal" action="../Controles/Registro/CExcel.php" method="POST" enctype="multipart/form-data">
                    <input type="hidden" id="hiddenexcel" name="hidden_excel" value="requerimientos"> 
                  <div class="box-body">
