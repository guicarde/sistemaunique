...
if(!isset($_SESSION['mensaje_plataforma'])){ 
    $_SESSION['mensaje_plataforma']="Los datos se registraron satisfactoriamente";
}
if(isset($_SESSION['plataforma_idplataforma']))         { $id = $_SESSION['plataforma_idplataforma'];} else{ $id =""; }
if(isset($_SESSION['plataforma_nombre']))         { $nombres = $_SESSION['plataforma_nombre'];} else{ $nombres =""; }
if(isset($_SESSION['plataforma_estado']))         { $estado = $_SESSION['plataforma_estado'];} else{ $estado =""; }
if(isset($_SESSION['plataforma_fecharegistro']))         { $fechareg = $_SESSION['plataforma_fecharegistro'];} else{ $fechareg =""; }
           ...
           <div class="col-md-12">
              ...
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Datos del la Plataforma</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" action="../Controles/Registro/CPlataforma.php" method="POST" enctype="multipart/form-data">
                    <input type="hidden" id="hiddenplataforma" name="hidden_plataforma" value="save">  
                    <input type="hidden" name="idplat" value="<?php echo $id; ?>"/>
                  <div class="box-body">
                    <div class="form-group">
                      <label for="inputnombre" class="col-sm-2 control-label">Plataforma</label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="t_plataforma" value="<?php echo $nombres; ?>" placeholder="Ingrese Plataforma">
                      </div>
                    </div>
						  ...
						  <div class="modal-dialog">
						    <div class="modal-content">
						      ...
						      <div class="modal-body">
						        <?php echo $_SESSION['mensaje_plataforma'];?>
						      </div>
