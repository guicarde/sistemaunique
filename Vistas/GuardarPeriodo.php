...
if(!isset($_SESSION['mensaje_periodo'])){ 
     ...
     <?php require 'Cabecera.php' ?>
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li class="active">
                  ...
                  <ul class="treeview-menu">
                      <li class="active"><a href="GuardarPeriodo.php"><i class="fa fa-circle-o"></i> Guardar Periodo </a></li>                    
                  </ul>
                  <ul class="treeview-menu">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            REGISTRAR PERIODO
            <small>Ingrese Datos del Periodo</small>
          </h1>
          <ol class="breadcrumb">
           ...
           <div class="col-md-12">
              ...
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Datos del Periodo</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" action="../Controles/Registro/CPeriodo.php" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="box-body">
                      <div class="form-group">
                          <label class="col-sm-2 col-sm-2 control-label"><span class="pull-left">Nombre</span></label>
                              <div class="col-sm-10">
                                  <input type="text" name="t_nombre" class="form-control" value="<?php echo $nombre?>" required>
                              </div>
                          </div>
                    <div class="form-group">
                        <label for="inputnombre" class="col-sm-2 control-label"><span class="pull-left">Archivo TXT</span></label>
                      <div class="col-sm-10">
						  ...
						  <div class="modal-dialog">
						    <div class="modal-content">
						      ...
						      <div class="modal-body">
						        <?php echo $_SESSION['mensaje_periodo'];?>
						      </div>
