...
if (isset($_SESSION['accion_categoria']) && $_SESSION['accion_categoria'] != '') {

    if ($_SESSION['accion_categoria'] == 'busqueda') {
        $categorias = $_SESSION['arreglo_buscado_categoria'];
    } else {
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            MANTENER CATEGORÍA
            <small>Busqueda de Categoria</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="index.php"><i class="fa fa-user"></i> CATEGORIA</a></li>
            <li><a href="index.php">Categoria</a></li>
            <li class="active">Mantener Categoria</li>
          </ol>
        </section>
        ...
        <section class="content">
         ...
         <div class="row"> 
          <form class="form-horizontal" action="../Controles/Registro/CCategoria.php" method="POST">
              <input type="hidden" id="hiddenusuario" name="hidden_categoria" value="buscar"> 
           <div class="col-md-6">
              <!-- Horizontal Form -->
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Busqueda de la Categoria</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      <label for="inputnombres" class="col-sm-2 control-label">Categoria</label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="t_categoria" placeholder="Ingrese Descripción">
                      </div>
                    </div>    
    ...
    foreach ($categorias as $c) {
        ?>
                      <tr>
                        ...
                        <td>
                             <?php if ($c['categoria_estado']=='0'){?> 
                            <div class="callout callout-danger">
                                <p>Inactivo</p>
                            </div>
                            <?php } ?>
                            <?php if ($c['categoria_estado']=='1'){?> 
                        ...
                        <td><?php echo $c['categoria_fecharegistro'] ?></td>
                        <td><?php if($c['categoria_estado']=='1') {?>
                                                        <form method='POST' id="formusu" action="../Controles/Registro/CCategoria.php">
                                                            <input type="hidden" name="id_hidden_eliminar" value="<?php echo $c['categoria_idcategoria'] ?>">
                                                            <input type="hidden" name="hidden_categoria" value="anular">
                        ...
                        <td>
                                                       <form method='POST' id="formusu" action="../Controles/Registro/CCategoria.php">
                                                            <input type="hidden" name="hidden_categoria" value="buscarid">
                                                            <input type="hidden" name="idcat" value="<?php echo $c['categoria_idcategoria'] ?>">
