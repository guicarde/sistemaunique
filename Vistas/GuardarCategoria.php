...
if(isset($_SESSION['categoria_idcategoria']))         { $id = $_SESSION['categoria_idcategoria'];} else{ $id =""; }
if(isset($_SESSION['categoria_nombre']))         { $nombres = $_SESSION['categoria_nombre'];} else{ $nombres =""; }
if(isset($_SESSION['categoria_estado']))         { $estado = $_SESSION['categoria_estado'];} else{ $estado =""; }
if(isset($_SESSION['categoria_fecharegistro']))         { $fechareg = $_SESSION['categoria_fecharegistro'];} else{ $fechareg =""; }
     ...
     <?php require 'Cabecera.php' ?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            REGISTRAR CATEGORIA
            <small>Ingrese Datos de la Categoria</small>
          </h1>
          <ol class="breadcrumb">
           ...
           <div class="col-md-12">
              ...
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Datos del la Categoria</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" action="../Controles/Registro/CCategoria.php" method="POST" enctype="multipart/form-data">
                    <input type="hidden" id="hiddencategoria" name="hidden_categoria" value="save">  
                    <input type="hidden" name="idcat" value="<?php echo $id; ?>"/>
                  <div class="box-body">
                    <div class="form-group">
                      <label for="inputnombre" class="col-sm-2 control-label">Categoria</label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="t_categoria" value="<?php echo $nombres; ?>" placeholder="Ingrese Categoria">
                      </div>
                    </div>
						  ...
						  <div class="modal-dialog">
						    <div class="modal-content">
						      ...
						      <div class="modal-body">
						        <?php echo $_SESSION['mensaje_categoria'];?>
						      </div>
