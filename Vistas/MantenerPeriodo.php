    ...
    <div class="wrapper">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li  class="active">
                  ...
                  <ul class="treeview-menu">
                      <li  class="active"><a href="MantenerPeriodo.php"><i class="fa fa-circle-o"></i> Mantener Periodo </a></li>                    
                  </ul>
                </li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            MANTENER PERIODO
            <small>Busqueda de Periodo</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="index.php"><i class="fa fa-user"></i> PERIODO</a></li>
            <li><a href="index.php">Periodo</a></li>
            <li class="active">Mantener Periodo</li>
          </ol>
        </section>
        ...
        <section class="content">
         ...
         <div class="row"> 
          <form class="form-horizontal" action="../Controles/Registro/CPeriodo.php" method="POST">
              <input type="hidden" id="hiddenusuario" name="hidden_periodo" value="buscar"> 
           <div class="col-md-6">
              <!-- Horizontal Form -->
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Busqueda del Periodo</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                  ...
                  <div class="box-body">
                   <div class="form-group">
                       <label class="col-sm-4 control-label"><span class="pull-left">Nombre Periodo</span></label>
                                        <div class="col-sm-8">
                                            <input type="text" name="t_nombre" class="form-control">
                                        </div>
                                    </div>
                    <div class="form-group">
                        <label for="inputestado" class="col-sm-4 control-label"><span class="pull-left">Estado</span></label>
                                        <div class="col-sm-8">
            ...
            <div class="col-md-6">
             <div class="box box-info">
                ...
                <div class="box-body">
                                    <div class="form-group">
                                        <label for="inputfecha" class="col-sm-4 control-label"><span class="pull-left">Fecha de Registro</span></label>
                                        <div class="col-sm-8">
                                        <div class="input-group">
 ...
 <?php if ($periodos != null) { ?>
                    <thead>
                      <tr>
                        ...
                        <th>FECHAS ASIGNADAS AL PERIODO</th>
                        <th>ESTADO</th>
                        ...
                        <td><?php echo $num;
                                        $num++; ?></td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="checkbox" id="inlineCheckbox<?php echo $f['periodofecha_idperiodofecha']; ?>" name="check_list[]" checked disabled value="<?php echo $f['periodofecha_idperiodofecha']; ?>"> <?php echo $f['periodofecha_fecha'];  ?>
                                                        </label><br>
                                                    ...
                                                    <td><?php echo $r['periodo_fecharegistro'] ?></td>
                        <td><?php if($r['periodo_estado']=='1') {?>
