    ...
    <div class="wrapper">
           ...
           <ul class="sidebar-menu">
            ...
            <li  class="active treeview" >
              ...
              <ul class="treeview-menu">
                  ...
                  <ul class="treeview-menu">
                      <li class="active"><a href="MantenerRCT.php"><i class="fa fa-circle-o"></i> Mantener RCT </a></li>                    
                  </ul>
                </li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            MANTENER REPORTE DE CAMBIOS
            <small>Busqueda de Reporte de Cambios</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="index.php"><i class="fa fa-user"></i> RCT</a></li>
            <li><a href="index.php">RCT</a></li>
            <li class="active">Mantener RCT</li>
          </ol>
        </section>
           ...
           <div class="col-md-6">
              ...
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Busqueda de RCT</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <option value=""> --SELECCIONE--</option>
                                            <option value="1">TAREA SCHEDULE</option>
                                            ...
                                            <option value="6">PROBLEMA</option>
                                            <option value="7">DESACTIVACIÓN</option>
                ...
                <div class="box-body">
                    <div class="form-group">
                           <label class="col-sm-2 col-sm-2 control-label">Detalle</label>
                              <div class="col-sm-10">
                                  <textarea name="ta_detalle" id="id_detalle" class="form-control" rows="2" placeholder="Ingrese Detalle" ></textarea>
                              </div>
                     </div>
                    <div class="form-group">
    ...
    foreach ($rcts as $r) {
        ?>
                      <tr style="font-size:8pt;">
                        ...
                        <td><?php if($r['rct_tiporegistro']=='1'){echo "TAREA SCHEDULE";}
                                  if($r['rct_tiporegistro']=='2'){echo "NOTICIA";}
                                  if($r['rct_tiporegistro']=='3'){echo "CAMBIO";}
                                  if($r['rct_tiporegistro']=='4'){echo "REQUERIMIENTO";}
                                  if($r['rct_tiporegistro']=='5'){echo "INCIDENTE";}
                        ...
                        <td align="center">
                           <?php if ($r['rct_archivo']!='') {?> 
                            <a href="../Controles/Rct/<?php echo $r['rct_archivo']?>" target="_new" class="label label-info label-mini">PLAN DE TRABAJO</a>
