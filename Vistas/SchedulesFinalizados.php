...
if (isset($_SESSION['accion_schedule_finalizado']) && $_SESSION['accion_schedule_finalizado'] != '') {

    if ($_SESSION['accion_schedule_finalizado'] == 'busqueda') {
        $schedules = $_SESSION['arreglo_buscado_schedule_finalizado'];
    } else {
        $schedules = $schedule->listar_sc_finalizados($schedule);
    }
} else {
    $schedules = $schedule->listar_sc_finalizados($schedule);
}
           ...
           <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                  ...
                  <ul class="treeview-menu">
                      <li class="active"><a href="SchedulesFinalizados.php"><i class="fa fa-circle-o"></i> Schedules Finalizados </a></li>                    
                  </ul>
                </li>
      ...
      <div class="content-wrapper">
        ...
        <div class="row"> 
             <form class="form-horizontal" action="../Controles/Registro/CSchedule.php" method="POST">
              <input type="hidden" id="hidden_schedule" name="hidden_schedule" value="buscar_finalizados"> 
           <div class="col-md-6">
              <!-- Horizontal Form -->
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Busqueda de Schedule Finalizado</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                  ...
                  <div class="box-body">
                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control select2" style="width: 100%;" name="c_operador">
                                                <option value="0">--SELECCIONE--</option>
                                                <?php foreach ($usuarios as $u) {   
                                                                          ?>

                                                                          <option value="<?php echo $u['usu_idusu']; ?>"><?php echo $u['usu_apellidos_usuario'].' '.$u['usu_nombres_usuario']; ?></option>
                                                                      <?php } ?>
                                            </select>
                                        </div>
                                    </div>    
         ...
         <div class="row"> 
             <div class="col-md-12">
                ...
                <div class="box-header">
                  <h3 class="box-title">RESULTADO DE BUSQUEDA DE SCHEDULES FINALIZADOS</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
    ...
    foreach ($schedules as $s) {
        ?>
                      <tr>
                        ...
                        <td><?php echo $s['usu_apellidos_usuario'].' '.$s['usu_nombres_usuario'] ?></td>
                        <td>
                            <form method='POST' action="../Controles/Registro/CReportesPdf.php" target="_new">
                                ...
                                <button type="submit" class="btn btn-twitter btn-xs"  title="Ver Detalle Schedule"><i class="fa fa-file-pdf-o "> REPORTE SCHEDULE FINALIZADO</i></button>
                            </form>   
                        </td>
                      </tr>
                      <?php } ?>
