           ...
           <li class="active treeview">
              ...
              <ul class="treeview-menu">
                <li class="active">
                  ...
                  <ul class="treeview-menu">
                      <li class="active"><a href="MantenerUsuario.php"><i class="fa fa-circle-o"></i> Mantener Usuario </a></li>                    
                  </ul>                  
                </li>
           ...
           <div class="col-md-6">
              ...
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Busqueda del Usuario</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="t_nombres" placeholder="Ingrese Descripción">
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="inputpaterno" class="col-sm-2 control-label">Apellidos</label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="t_apellidos" placeholder="Ingrese Descripción">
                      </div>
                    </div>     
