...
if(!isset($_SESSION['accion_plataforma'])){ 
    $_SESSION['accion_plataforma']="";
}
include_once '../DAO/Registro/Plataforma.php';
$plataforma = new Plataforma();

if (isset($_SESSION['accion_plataforma']) && $_SESSION['accion_plataforma'] != '') {

    if ($_SESSION['accion_plataforma'] == 'busqueda') {
        $plataformas = $_SESSION['arreglo_buscado_plataforma'];
    } else {
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            MANTENER PLATAFORMA
            <small>Busqueda de Plataforma</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="index.php"><i class="fa fa-user"></i> PLATAFORMA</a></li>
            <li><a href="index.php">Plataforma</a></li>
            <li class="active">Mantener Plataforma</li>
          </ol>
        </section>
        ...
        <section class="content">
         ...
         <div class="row"> 
          <form class="form-horizontal" action="../Controles/Registro/CPlataforma.php" method="POST">
              <input type="hidden" id="hiddenplataforma" name="hidden_plataforma" value="buscar"> 
           <div class="col-md-6">
              <!-- Horizontal Form -->
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Busqueda de la Plataforma</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      <label for="inputnombres" class="col-sm-2 control-label">Plataforma</label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="t_plataforma" placeholder="Ingrese Descripción">
                      </div>
                    </div>    
    ...
    foreach ($plataformas as $p) {
        ?>
                      <tr>
                        ...
                        <td><?php echo $p['plataforma_nombre']; ?></td>                                  
                        <td>
                             <?php if ($p['plataforma_estado']=='0'){?> 
                            <div class="callout callout-danger">
                                <p>Inactivo</p>
                            </div>
                            <?php } ?>
                            <?php if ($p['plataforma_estado']=='1'){?> 
                        ...
                        <td><?php echo $p['plataforma_fecharegistro'] ?></td>
                        <td><?php if($p['plataforma_estado']=='1') {?>
                                                        <form method='POST' id="formplat" action="../Controles/Registro/CPlataforma.php">
                                                            <input type="hidden" name="id_hidden_eliminar" value="<?php echo $p['plataforma_idplataforma'] ?>">
                                                            <input type="hidden" name="hidden_plataforma" value="anular">
                                                            <input type="hidden" name="hidden_estado" value="activo">
                                                            <button type="submit" class="btn btn-block btn-danger btn-xs" title="Desactivar">DESACTIVAR</button>
                                                        ...
                                                        <form method='POST' id="formplat" action="../Controles/Registro/CPlataforma.php">
                                                            ...
                                                            <button type="submit" class="btn btn-block btn-success btn-xs" title="Activar">ACTIVAR</button>
                                                        </form>   
                                                       <?php } ?>
                        </td>
                        <td>
                                                       <form method='POST' id="formplat" action="../Controles/Registro/CPlataforma.php">
                                                            <input type="hidden" name="hidden_plataforma" value="buscarid">
                                                            <input type="hidden" name="idplat" value="<?php echo $p['plataforma_idplataforma'] ?>">
