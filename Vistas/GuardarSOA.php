...
if(!isset($_SESSION['mensaje_soa'])){ 
    $_SESSION['mensaje_soa']="Los datos se registraron satisfactoriamente";
}
...
if(isset($_SESSION['soa_idsoa']))         { $id = $_SESSION['soa_idsoa'];} else{ $id =""; }
if(isset($_SESSION['soa_turno']))         { $turno = $_SESSION['soa_turno'];} else{ $turno =""; }
if(isset($_SESSION['soa_servidor']))         { $servidor = $_SESSION['soa_servidor'];} else{ $servidor =""; }
if(isset($_SESSION['soa_ip']))         { $ip = $_SESSION['soa_ip'];} else{ $ip =""; }
if(isset($_SESSION['soa_site']))         { $site = $_SESSION['soa_site'];} else{ $site =""; }
if(isset($_SESSION['soa_herramienta']))         { $herramienta = $_SESSION['soa_herramienta'];} else{ $herramienta =""; }
if(isset($_SESSION['soa_tipo']))         { $tipo = $_SESSION['soa_tipo'];} else{ $tipo =""; }
if(isset($_SESSION['periodo_idperiodo']))         { $idperiodo = $_SESSION['periodo_idperiodo'];} else{ $idperiodo =""; }
if(isset($_SESSION['soa_hora']))         { $hora = $_SESSION['soa_hora'];} else{ $hora =""; }
     ...
     <?php require 'Cabecera.php' ?>
          ...
          <!-- sidebar menu: : style can be found in sidebar.less -->
           ...
           <li class="active treeview">
              ...
              <ul class="treeview-menu">
                  ...
                  <ul class="treeview-menu">
                      <li class="active"><a href="GuardarSOA.php"><i class="fa fa-circle-o"></i> Registrar SAP - SOA </a></li>                    
                  </ul>
                  <ul class="treeview-menu">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            REGISTRAR SAP - SOA
            <small>Ingrese Datos del Backup SAP - SOA</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="index.php"><i class="fa fa-user"></i> SAP - SOA</a></li>
            <li><a href="index.php">Sap - Soa</a></li>
            <li class="active">Registrar Backup SAP -SOA</li>
          </ol>
        </section>
           ...
           <div class="col-md-12">
              ...
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Datos del backup SAP - SOA</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" action="../Controles/Registro/CSap.php" method="POST">
                    <input type="hidden" id="hiddensap" name="hidden_sap" value="save">  
                    <input type="hidden" name="idsap" value="<?php echo $id; ?>"/>
                  <div class="box-body">
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="t_servidor" value="<?php echo $servidor; ?>" placeholder="Ingrese Servidor">
                      </div>
                    </div> 
                    <div class="form-group">
                      <label for="inputservidor" class="col-sm-2 control-label">Ip</label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="t_ip" value="<?php echo $ip; ?>" placeholder="Ingrese IP">
                      </div>
                    </div>  
                     <div class="form-group">
                                        <label for="inputsite" class="col-sm-2 control-label">Site</label>
                                        <div class="col-sm-10">
                                            <select class="form-control select2" name="c_site" id="id_site" >
                                                    <option value=""> --SELECCIONE--</option>
                                                    <option value="1" <?php if ($site=='1'){ echo 'selected';}?>>ARAMBURÚ</option>
                                                    <option value="2" <?php if ($site=='2'){ echo 'selected';}?>>LA MOLINA</option>
                                             </select>
                                        </div>
                     </div>
                      <div class="form-group">
                      <label for="inputherramienta" class="col-sm-2 control-label">Herramienta</label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="t_herramienta" value="<?php echo $herramienta; ?>" placeholder="Ingrese Herramienta">
                      </div>
                    </div> 
                      <div class="form-group">
                      <label for="inputtipo" class="col-sm-2 control-label">Tipo de Backup</label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="t_tipo" value="<?php echo $tipo; ?>" placeholder="Ingrese tipo de Backup">
                      </div>
                    </div> 
                    <div class="form-group">
                   ...
                   <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="time" name="t_hora" maxlength="8" value="<?php echo $hora; ?>" class="form-control" required>
                              </div>
                          </div>   
                  </div><!-- /.box-body -->
