...
if (isset($_SESSION['accion_schedule']) && $_SESSION['accion_schedule'] != '') {
    ...
    if ($_SESSION['accion_schedule'] == 'busqueda') {
        ...
        $schedules = $schedule->listar_sin_asignar();
    }
} else {
    $schedules = $schedule->listar_sin_asignar();
}
    ...
    <div class="wrapper">
           ...
           <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                  ...
                  <ul class="treeview-menu">
                      <li class="active"><a href="SeleccionarSchedule.php"><i class="fa fa-circle-o"></i> Seleccionar Schedule </a></li>                    
                  </ul>
                  <ul class="treeview-menu">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            SELECCIONAR SCHEDULE PARA OPERADOR
            <small>Selección de Schedule</small>
          </h1>
          <ol class="breadcrumb">
         ...
         <div class="row"> 
             <div class="col-md-12">
                ...
                <div class="box-header">
                  <h3 class="box-title">LISTA DE SCHEDULES DISPONIBLES</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
    ...
    foreach ($schedules as $s) {
        ?>
                      <tr>
                        ...
                        <td><?php echo $s['schedule_fecha'] ?></td>   
                        ...
                        <td>
                            <form method='POST' action="../Controles/Registro/CSchedule.php">
                                <input type="hidden" name="id_schedule" value="<?php echo $s['schedule_idschedule'] ?>">
                                <input type="hidden" name="hidden_schedule" value="seleccionar_schedule">
                                <button type="submit" class="btn btn-warning btn-xs"  title="Seleccionar Schedule"><i class="fa fa-archive "> SELECCIONAR SCHEDULE</i></button>
                            </form>                                                       

                        </td>
                        <td>
                                                        <form method='POST' id='form_eliminar<?php echo $s['schedule_idschedule'];?>' action="../Controles/Registro/CSchedule.php">
                                                            <input type="hidden" name="id_schedule" value="<?php echo $s['schedule_idschedule'] ?>">
                                                            <input type="hidden" name="hidden_schedule" value="elimina_schedule">
                                                            <button type="button" onclick="validar(<?php echo $s['schedule_idschedule'];?>);" class="btn btn-danger btn-xs"  title="Eliminar"><i class="fa fa-trash-o "></i></button>
                                                        </form> 
                                                    </td>
                      </tr>
                      <?php } ?>
...
<!--                                        <center><label>Su búsqueda no produjo ningún resultado. </label></center>-->
    ...
    <script>
           function validar(id_schedule) { 

    if(confirm('Usted va a Eliminar el Schedule seleccionado!  \n \n Esta seguro de continuar  ?')) { 

           if(confirm(' Esta seguro ?  \n Esto implica todas los registros efectuado en este schedule se borrarán .\n Esta completamente seguro de continuar?')) {document.getElementById('form_eliminar'+id_schedule).submit();} 
