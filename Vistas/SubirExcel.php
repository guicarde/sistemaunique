...
//------------------------------------------------
if(!isset($_SESSION['accion_excel'])){ 
    $_SESSION['accion_excel']="";
}
//
     ...
     <?php require 'Cabecera.php' ?>
           ...
           <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                  ...
                  <ul class="treeview-menu">
                      <li class="active"><a href="SubirExcel.php"><i class="fa fa-circle-o"></i> Subir Tareas Excel</a></li>                    
                  </ul>
                </li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Subir Consolidado de Tareas
            <small>Ingrese Adjunto en excel</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="index.php"><i class="fa fa-user"></i> ACTIVIDAD</a></li>
            <li><a href="index.php">Actividad</a></li>
            <li class="active">Subir Excel</li>
          </ol>
        </section>
           ...
           <div class="col-md-12">
              ...
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Ingresar Consolidado de Excel (ADJUNTO)</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" action="../Controles/Registro/CExcel.php" method="POST" enctype="multipart/form-data">
                    <input type="hidden" id="hiddenexcel" name="hidden_excel" value="save"> 
                  <div class="box-body">
                    
                   
                    <div class="form-group">
                      <label for="inputEmail3" class="col-sm-2 control-label">Adjunto en Excel</label>
                      <div class="col-sm-10">
